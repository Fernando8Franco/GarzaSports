...
<body>
    ...
    <script
        src="<?= URL_PATH ?>/assets/datatables/js/cdn.datatables.net_buttons_2.4.1_js_buttons.print.min.js"></script>
    <script src="<?= URL_PATH ?>/assets/js/scripts.print.js"></script>
