...
<div class="l-navbar" id="nav-bar">
  <nav class="nav">
    <div>
      ...
      <div class="nav_list">
        <a href="" class="nav_link active" hx-get="/public/admin/start" hx-target="#targetPHP">
        <i class="fa-solid fa-gauge-high nav_icon"></i>
          <span class="nav_name">Inicio</span>
        </a>
        <a href="" class="nav_link" hx-get="/public/events/index" hx-target="#targetPHP">
        <i class="fa-solid fa-calendar-days nav_icon"></i>
          <span class="nav_name">Eventos</span>
        </a>
        <a href="#" class="nav_link" hx-get="/public/users/index" hx-target="#targetPHP">
        <i class="fa-solid fa-user-gear nav_icon"></i>
          <span class="nav_name">Usuarios</span>
        </a>
        <a href="" class="nav_link" hx-get="/public/dependencies/index" hx-target="#targetPHP">
        <i class="fa-solid fa-landmark nav_icon"></i>
          <span class="nav_name">Dependencias</span>
        </a>
        <a href="" class="nav_link" hx-get="/public/sports/dependencies/index" hx-target="#targetPHP">
          <i class="fa-solid fa-volleyball nav_icon"></i>
          <span class="nav_name">Deportes</span>
        </a>
        <a href="" class="nav_link" hx-get="/public/records/index" hx-target="#targetPHP">
          <i class="fa-solid fa-file-pen nav_icon"></i>
          <span class="nav_name">Inscripciones</span>
        </a>
        <a href="" class="nav_link" hx-get="/public/players/index" hx-target="#targetPHP">
          <i class="fa-solid fa-address-book nav_icon"></i>
          <span class="nav_name">Participantes</span>
        </a>
        <a href="" class="nav_link" hx-get="/public/teams/index" hx-target="#targetPHP">
...
<div class="main" hx-get="/public/admin/start" hx-trigger="load" hx-target="#targetPHP">
