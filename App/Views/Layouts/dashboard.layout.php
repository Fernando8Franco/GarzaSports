...
<head>
    ...
    <link rel="stylesheet" href="<?= URL_PATH ?>/assets/datatables/css/cdn.datatables.net_1.13.6_css_dataTables.bootstrap5.min.css">
    ...
    <body id="body-pd">
        ...
        <script defer src="<?= URL_PATH ?>/assets/datatables/js/code.jquery.com_jquery-3.7.0.js"></script>
        <script defer src="<?= URL_PATH ?>/assets/datatables/js/cdn.datatables.net_1.13.6_js_jquery.dataTables.min.js"></script>
        <script defer src="<?= URL_PATH ?>/assets/datatables/js/cdn.datatables.net_1.13.6_js_dataTables.bootstrap5.min.js"></script>
        <script defer src="<?= URL_PATH ?>/assets/js/scripts.dashboard.js"></script>
    </body>
</html>